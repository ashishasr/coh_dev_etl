--------------------------------------------------------
--  DDL for Package Body PKG_LOAD_3_CMN_ASSET_PERFORMANCE_INFO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "COH_DEV_T"."PKG_LOAD_3_CMN_ASSET_PERFORMANCE_INFO" AS
    ...
    PROCEDURE proc_load_common_asset_cleaned_3_performance_info AS
    BEGIN
        execute immediate 'truncate table load_common_asset_cleaned_3_performance_info';

        COMMIT;
        INSERT INTO load_common_asset_cleaned_3_performance_info (
            asset_id,
            ...
            SELECT
                a.asset_id,
                pkg_load_3_cmn_asset_performance_info.get_performace_matrix_answers('Performance Capacity', performance_capacity),
                pkg_load_3_cmn_asset_performance_info.get_performace_matrix_answers('Performance Reliability', performance_reliability),
                pkg_load_3_cmn_asset_performance_info.get_performace_matrix_answers('Performance OM', performance_om),
                pkg_load_3_cmn_asset_performance_info.get_performace_matrix_answers('Performance Obsolescence', performance_obsolescence),
                pkg_load_3_cmn_asset_performance_info.get_performace_matrix_answers('Performance Redundancy', performance_redundancy)
            FROM
                     wwo_common_asset_cleaned_no_calc a 
                INNER JOIN load_common_asset_cleaned_1_asset_info b ON a.asset_id = b.asset_id
                and  reject_flag = 'N'  ;

        COMMIT;
        UPDATE load_common_asset_cleaned_3_performance_info
        SET
            performance_score = pkg_load_3_cmn_asset_performance_info.get_performance_score(performance_capacity, performance_reliability, performance_om
            , performance_obsolescence, performance_redundancy);

        COMMIT;
        UPDATE load_common_asset_cleaned_3_performance_info
        SET
            performance_rating = pkg_load_3_cmn_asset_performance_info.get_performance_rating(performance_score);

        COMMIT;
        UPDATE load_common_asset_cleaned_3_performance_info
        SET
            redundancy_factor_revised = pkg_load_3_cmn_asset_performance_info.get_redundancy_factor_revised(performance_redundancy);
    ...
    BEGIN
        proc_load_common_asset_cleaned_3_performance_info;
    END;
