--------------------------------------------------------
--  DDL for Package Body PKG_LOAD_4_CMN_ASSET_AMC_INFO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "COH_DEV_T"."PKG_LOAD_4_CMN_ASSET_AMC_INFO" AS
...
------------------------------------------
    PROCEDURE proc_load_common_asset_cleaned_4_amc_info IS
    BEGIN
        execute immediate 'truncate table load_common_asset_cleaned_4_amc_info';

        COMMIT;
        INSERT INTO load_common_asset_cleaned_4_amc_info (
            asset_id,
            class_id,
            class_description,
            category_id,
        ...
        COMMIT;
        UPDATE load_common_asset_cleaned_4_amc_info
        SET
            age = pkg_load_4_cmn_asset_amc_info.get_amc_age(min_system_commission_year);

        COMMIT;
        UPDATE load_common_asset_cleaned_4_amc_info
        SET
            life_remaining = pkg_load_4_cmn_asset_amc_info.get_amc_life_remaining(estimated_useful_life, age);

        COMMIT;
        UPDATE load_common_asset_cleaned_4_amc_info
        SET
            percent_life_consumed_number = pkg_load_4_cmn_asset_amc_info.get_amc_percent_life_consumed_number(estimated_useful_life, life_remaining);
        ...
        UPDATE load_common_asset_cleaned_4_amc_info
        SET
            condition_adjusted_useful_life = pkg_load_4_cmn_asset_amc_info.get_amc_condition_adjusted_useful_life(condition_score, percent_life_consumed_number
            , estimated_useful_life, age);

        COMMIT;
        UPDATE load_common_asset_cleaned_4_amc_info
        SET
            condition_adjusted_life_remaining = pkg_load_4_cmn_asset_amc_info.get_amc_condition_adjusted_life_remaining(condition_adjusted_useful_life
            , age);

        COMMIT;
        UPDATE load_common_asset_cleaned_4_amc_info
        SET
            condition_adjusted_percent_life_consumed_number = pkg_load_4_cmn_asset_amc_info.get_amc_condition_adjusted_percent_life_consumed_number(estimated_useful_life
        ...
        UPDATE load_common_asset_cleaned_4_amc_info
        SET
            predicted_replacement_year = pkg_load_4_cmn_asset_amc_info.get_amc_predicted_replacement_year(condition_adjusted_life_remaining
            );

        COMMIT;
        UPDATE load_common_asset_cleaned_4_amc_info
        SET
            predicted_cip_year = pkg_load_4_cmn_asset_amc_info.get_amc_predicted_cip_year(condition_adjusted_life_remaining);
    ...
    BEGIN
        proc_load_common_asset_cleaned_4_amc_info;
    END;
