--------------------------------------------------------
--  DDL for Package Body PKG_LOAD_5_ASSET_COF_INFO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "COH_DEV_T"."PKG_LOAD_5_ASSET_COF_INFO" AS
    ...
    PROCEDURE proc_load_unq_asset_cleaned_5_cof_info AS
    BEGIN
        execute immediate 'truncate table load_unq_asset_cleaned_5_cof_info';

        COMMIT;
        INSERT INTO load_unq_asset_cleaned_5_cof_info (
            asset_id,
            ...
            SELECT
                a.asset_id,
                pkg_load_5_asset_cof_info.get_cof_matrix_answers('COF Replacement Cost', cof_replacement_cost),
                pkg_load_5_asset_cof_info.get_cof_matrix_answers('COF O&M Impact', cof_om_impacts),
                pkg_load_5_asset_cof_info.get_cof_matrix_answers('COF Level of Service', cof_level_of_service),
                pkg_load_5_asset_cof_info.get_cof_matrix_answers('COF Health and Safety', cof_health_and_safety),
                pkg_load_5_asset_cof_info.get_cof_matrix_answers('COF Permit Compliance', cof_permit_compliance),
                pkg_load_5_asset_cof_info.get_cof_matrix_answers('COF Response Time', cof_response_time),
                pkg_load_5_asset_cof_info.get_cof_matrix_answers('COF Service Priority', cof_service_priority)
            FROM
                     wwo_unq_asset_cleaned_no_calc a
                INNER JOIN load_unq_asset_cleaned_1_asset_info b ON a.asset_id = b.asset_id;

        COMMIT;
        UPDATE load_unq_asset_cleaned_5_cof_info
        SET
            cof_score = pkg_load_5_asset_cof_info.get_cof_score(cof_replacement_cost, cof_om_impacts, cof_level_of_service, cof_health_and_safety
            , cof_permit_compliance,
        ...
        UPDATE load_unq_asset_cleaned_5_cof_info
        SET
            cof_rating = pkg_load_5_asset_cof_info.get_cof_rating(cof_score);
    ...
    BEGIN
        proc_load_unq_asset_cleaned_5_cof_info;
    END;
