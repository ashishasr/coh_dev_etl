--------------------------------------------------------
--  DDL for Package Body PKG_EXECUTE_P8_CMN_ASSET_CALCULATIONS_REFRESH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "COH_DEV_T"."PKG_EXECUTE_P8_CMN_ASSET_CALCULATIONS_REFRESH" AS
...
END pkg_execute_p8_cmn_asset_calculations_refresh;
